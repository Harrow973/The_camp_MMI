    // ROUTES (alignées sur la structure d’enigme2)
    // Retour: on revient au dialogue du professeur (ton flux actuel)
    const BACK_URL = "pages/01-story/dialogue-professeur-artifact2.html";
    // Scan: page de scan du QR 3
    const NEXT_URL = "pages/02-puzzles/scanner3.html";
    ...
    function goScan(){
      ...
      const targetUrl = NEXT_URL + (selectedCharacter ? ("?char=" + encodeURIComponent(selectedCharacter)) : "");
      window.setTimeout(() => {
    ...
    // Tap on image also triggers “scan”
